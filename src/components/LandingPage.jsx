          ...
          <div className="col-md-12 ">
            <div className="d-flex justify-content-center align-items-center h-100 w-100 text-light">
              <div className="container">
                ...
                <p>
                  <a href="#" className="btn btn-primary me-2 " onClick={() => alert("Spenden Funktion befindet sich aktuell in Bearbeitung!")}>
                    Spenden
                  </a>
    ...
    <div className="container my-5 py-5">
      ...
      <div className="row ">
        <div className="col-lg-12 img-background">
          ...
          <p>
            <a className="btn btn-primary" href="#" onClick={() => alert("Spenden Funktion befindet sich aktuell in Bearbeitung!")}>
              Spenden
            </a>
          </p>
        </div>
